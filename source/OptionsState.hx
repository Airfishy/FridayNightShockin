...
class PreferencesSubstate extends MusicBeatSubstate
{
	...
	function changeSelection(change:Int = 0)
	{
		...
		switch(options[curSelected]) {
			...
			case 'Anti-Aliasing':
				daText = "Game with potato graphics";
			case 'Downscroll':
			...
			case 'Ghost Tapping':
				daText = "Leave this on if you want the game to be playable";
			case 'Swearing':
			...
			case 'Hide Song Length':
				daText = "If checked, the bar showing how much longer you will have to suffer \nwill be hidden.";
		}
