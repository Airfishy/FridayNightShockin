...
class TitleState extends MusicBeatState
{
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			{
				case 1:
					createCoolText(['Vs Surge Full Week by'], 45);
				// credTextShit.visible = true;
				case 3:
					addMoreText('Airfishy', 45);
					addMoreText('Mage Yams', 45);
                                        addMoreText('KumbayaNamaste', 45);
				// credTextShit.text += '\npresent...';
				...
				// credTextShit.screenCenter();
				case 5:
					createCoolText(['Thanks to ninjamuffin'], -60);
				case 7:
					addMoreText('For making', -60);
